...
const Homepage = () => {
  return (
    ...
    <section>
      <div className="container">
        <div className="hero">
          ...
          <div className="image_section">
            <div className="pic">
            <img src="https://vulk.cssninja.io/assets/illustrations/hero/laptop-woman.svg" className="image"/>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="cardportion">
          <Cardoption title="Campaigns"image={<Cardsvg1/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Task Management"image={<Cardsvg2/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Personal Dashboard"image={<Cardsvg3/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Payment Gateways"image={<Cardsvg4/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Time Management"image={<Cardsvg5/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Notifications"image={<Cardsvg6/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Social Integrations"image={<Cardsvg7/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
          <Cardoption title="Instant Messaging"image={<Cardsvg8/>} description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed videbimus. Hoc est non dividere, sed frangere." />
        </div>
      </section>
      <section>
        ...
        <div className="text_section">
          ...
          <div className="image_section">
            <div className="pic">
            <img src="https://vulk.cssninja.io/assets/illustrations/features/feature-1.png" className="image"/>
            </div>
          </div>
      ...
      <section>
        ...
        <div className="text_section">
          ...
          <div className="image_section">
            <div className="pic">
            <img src="https://vulk.cssninja.io/assets/illustrations/features/feature-3.png" className="image"/>
            </div>
          </div>
      ...
      <section>
        <div className="largecard_portion">
          <Bigcard head="Success Stories" heading="Learn how they built a successful business" paragraph="See how some of our customers leverage Vulk technology to increase profits and take back control from resellers" link="Read success stories" image="https://vulk.cssninja.io/assets/illustrations/features/feature-3.png"/>
          </div>
          </section>
          <section>
      ...
      <section>
        <div className="card3">
          ...
          <div className="solutioncard">
            ...
            <Cardsolution image="https://vulk.cssninja.io/assets/icons/colored/certificate.svg"title="Get profitability insights" description="Connect your PPC spend to individual product costs and see a granular view of your product-level profitability. Confidently make smart decisions with essential metrics and reporting."/>
          </div>
        </div>
      </section>
      <section>
      ...
      <section>
        ...
        <ul className="ul">
            <li className="l">PRODUCT</li>
            <li className="l1">Core features</li>
            <li className="l1">Extensions</li>
            <li className="l1">Marketing</li>
            <li className="l1">Sales Management</li>
            <li className="l1">Software</li>
        </ul>
    </div>
    <div className="iteams2">
        <ul className="ul">
            <li className="l">COMPANY</li>
            <li className="l1">Register</li>
            <li className="l1">14-Day Trial</li>
            <li className="l1">About Us</li>
            <li className="l1">Careers</li>
            <li className="l1">Latest News</li>
        </ul>
    </div>
    <div className="iteams3">
        <ul className="ul">
            <li className="l">API</li>
            <li className="l1">Getting Started</li>
            <li className="l1">API Reference</li>
            <li className="l1">Developer Guide</li>
    ...
    <div className="iteams4">
        <ul className="ul">
            <li className="l">ASSISTANCE</li>
            <li className="l1">Help Center</li>
            <li className="l1">Support Requests</li>
            <li className="l1">FAQs</li>
            <li className="l1">Licensing</li>
    ...
    <div className="iteams6">
        <h3>Copyright © Your Website 2020</h3>
